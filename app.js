    ...
    questions: [
      {
        ...
        options: [
          { letter: "A", text: "Для указания формата документа, который должна создать нейросеть" },
          { letter: "B", text: "Для того, чтобы нейросеть \"настроилась\" на нужный профессиональный язык и уровень детализации" },
          { letter: "C", text: "Для ограничения количества символов в ответе" },
          { letter: "D", text: "Для проверки грамматики ответа нейросети" }
        ],
        correctAnswer: "B"
      },
      {
        ...
        options: [
          ...
          { letter: "B", text: "Составь отчёт по отклонению фактического расхода материалов от планового по шаблону из файла Х" },
      ...
      },
      {
        ...
        type: "multiple_choice",
        points: 2,
        text: "Какой компонент промпта описывает пошаговый процесс выполнения задачи?",
        options: [
          { letter: "A", text: "Роль" },
      ...
      },
      {
        ...
        items: [
          ...
          { number: "2", text: "Данные (исходная информация)", correct: "А" },
          { number: "3", text: "Стиль ответа", correct: "В" }
        ],
        rightOptions: [
          { letter: "А", text: "Входная информация, на основе которой нейросеть будет выполнять задачу (материалы, даты, таблицы)" },
          { letter: "Б", text: "Определяет, в каком виде нейросеть должна представить результат - таблица, письмо, список" },
          { letter: "В", text: "Задаёт тональность и уровень детализации ответа (кратко, подробно, деловой стиль)" }
        ]
      },
      {
        id: 10,
        ...
        items: [
          ...
          { number: "3", text: "Структурированный документ с разделами", correct: "Б" }
        ],
        rightOptions: [
          ...
          { letter: "В", text: "Сметы, акты выполненных работ, ведомости материалов, графики работ" }
        ]
      }
    ]
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        items: [
          { number: "1", text: "Определение роли, задания и контекста запроса", correct: "А" },
          { number: "2", text: "Предоставление исходных данных", correct: "Б" },
          { number: "3", text: "Наполнение раздела и смена ролей", correct: "В" }
        ],
        rightOptions: [
          { letter: "А", text: "Определение цели, подхода, заказчика и формата документа" },
    ...
    questions: [
      {
        ...
        type: "multiple_choice",
        points: 2,
        text: "Какой из этих форматов ЛУЧШЕ всего использовать для сметы, ведомости материалов или графика выполнения работ??",
        options: [
          { letter: "A", text: "Таблица Markdown или xls" },
          { letter: "B", text: "Список (чек-лист)" },
          { letter: "C", text: "Схема (описание структуры)" },
          { letter: "D", text: "Пошаговое объяснение" }
        ],
        correctAnswer: "A"
      },
      {
        ...
        options: [
          ...
          { letter: "B", text: "Просьба к модели описать цепочку логики и расчётов пошагово перед финальным ответом" },
      ...
      },
      {
        ...
        type: "multiple_choice",
        points: 2,
        text: "Для какого типа задач ЛУЧШЕ всего подойдет сервис Perplexity в отделе ПТО?",
        options: [
          { letter: "A", text: "Для написания деловых писем заказчику" },
          { letter: "B", text: "Для поиска и проверки нормативной информации (ГОСТы, СНиПы, СП) с указанием ссылок на источники" },
          { letter: "C", text: "Для генерации креативных идей о дизайне" },
          { letter: "D", text: "Для создания изображений стройплощадки" }
        ],
        correctAnswer: "B"
      },
      {
        ...
        rightOptions: [
          ...
          { letter: "Б", text: "DeepSeek, GigaChat (универсальные чат-боты)" },
      ...
      },
      {
        ...
        items: [
          ...
          { number: "2", text: "Цепочка рассуждений Chain-of-Thought", correct: "А" },
          { number: "3", text: "Диалоговый промпт", correct: "Б" }
        ],
        rightOptions: [
          { letter: "А", text: "Просим модель объяснить логику своих рассуждений пошагово" },
          { letter: "Б", text: "Задать уточняющий вопрос, чтобы нейросеть доказала логику своего решения" },
    ...
    questions: [
      {
        ...
        options: [
          { letter: "A", text: "Локальные модели работают быстрее всех облачных сервисов" },
          { letter: "B", text: "Данные не покидают компьютер, что важно для безопасности конфиденциальной информации" },
          { letter: "C", text: "Локальные модели не тратят оперативную память вашего ноутбука" },
          { letter: "D", text: "Локальные модели не требуют установки дополнительного ПО" }
        ],
        correctAnswer: "B"
      },
      {
        ...
        options: [
          ...
          { letter: "B", text: "Сметы с коммерческими ценами, условия договоров с NDA и закрытая проектная документация" },
      ...
      },
      {
        ...
        rightOptions: [
          ...
          { letter: "Б", text: "Управляет степенью креативности и случайности ответов (0.2-0.4 для расчётов, 0.7-1.0 для идей)" },
      ...
      },
      {
        ...
        items: [
          ...
          { number: "3", text: "Модели более 100B", correct: "В" }
        ],
        rightOptions: [
          ...
          { letter: "В", text: "Не подойдут для ноутбука" }
        ]
      }
    ]
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        items: [
          { number: "1", text: "Создание первой версии скрипта или html-файла", correct: "В" },
        ...
        rightOptions: [
          ...
          { letter: "Б", text: "Если скрипт стал важным для бизнеса, стоит передать его программисту для доработки" },
